...
public class DirectoryPath : FileSystemPath, IPathObject, IEnumerable<FileSystemPath>
{
    ...
    public IEnumerable<DirectoryPath> EnumerateDirectories(
        string searchPattern,
        EnumerationOptions enumerationOptions)
        => Info.EnumerateDirectories(searchPattern, enumerationOptions).Select(directory => new DirectoryPath(directory));
    ...
    public IEnumerable<DirectoryPath> EnumerateDirectories(
        string searchPattern = "*",
        SearchOption searchOption = SearchOption.TopDirectoryOnly)
        => Info.EnumerateDirectories(searchPattern, searchOption).Select(directory => new DirectoryPath(directory));
