...
public class DirectoryPath : FileSystemPath, IPathObject, IEnumerable<FileSystemPath>
{
    ...
    public long GetSize(bool includeSymbolicLinks)
    {
        ...
        var subDirs = Info.GetDirectories()
            ...
            .Sum(dir => dir.EnumerateFiles("*", EnumerationOptionConstants.AllDirectories)
                        .Sum(file => file.Length));
    ...
    /// <summary>
    /// Returns and enumerable collection of directories. Allows passing of <see cref="EnumerationOptions"/>.
    /// </summary>
