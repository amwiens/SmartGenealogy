...
public class DownloadService : IDownloadService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        client.DefaultRequestHeaders.UserAgent.Add(new ProductInfoHeaderValue("SmartGenealogy", "1.0"));
        ...
        var delays = Backoff.DecorrelatedJitterBackoffV2(TimeSpan.FromMilliseconds(40), retryCount: 3);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        foreach (
            var delay in Backoff.DecorrelatedJitterBackoffV2(TimeSpan.FromMilliseconds(40), retryCount: 4))
        {
