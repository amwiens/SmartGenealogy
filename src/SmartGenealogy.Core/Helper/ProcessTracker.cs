...
public static partial class ProcessTracker
{
    ...
    private static readonly Lazy<JobObject?> ProcessTrackerJobLazy =
        new(() =>
        {
            ...
            var jobName = $"SG_ProcessTracker_{Environment.ProcessId}";
            ...
            {
                Logger.Error(ex, "Failed to create Job Object, ProcessTracker will be unavailable");
                return null;
            }
        });
    ...
    public static void AddProcess(Process process)
    {
        ...
        // Skip if process already exited, this sometimes throw
        try
        {
    ...
    public static void AttachExitHandlerJobToProcess(Process process)
    {
        ...
        var jobName = $"SG_ProcessTracker_{Environment.ProcessId}_Instance_{process.Id}";
