...
public static class Compat
{
    ...
    /// <summary>
    /// AppData + AppName (e.g. %AppData%\SmartGenealogy)
    /// </summary>
    ...
    static Compat()
    {
        ...
        else if (RuntimeInformation.IsOSPlatform(OSPlatform.Linux))
        {
            ...
            AppCurrentDir = Path.GetDirectoryName(appPath) ?? throw new Exception("Could not find application directory");
            ExeExtension = "";
            DllExtension = ".so";
        }
        else
    ...
    /// <summary>
    /// Getneric function to return different objects based on platform flags.
