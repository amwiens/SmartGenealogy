...
public class WeakAction
{
    ...
    /// <summary>
    /// Gets or sets a boolean value indicating the action should be dispatched on the UI thread
    /// </summary>
    protected bool WithUiDispatch { get; set; }

    /// <summary>
    /// Gets or sets a boolean value indicating the action should be logged or not.
    /// </summary>
    ...
    /// <summary>
    /// The target or the weak action reference.
    /// </summary>
