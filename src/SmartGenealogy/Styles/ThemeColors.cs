...
namespace SmartGenealogy.Styles;
...
public static class ThemeColors
{
    ...
    public static readonly SolidColorBrush CompletionSelectionBackgroundBrush = SolidColorBrush.Parse("#2E436E");
    public static readonly SolidColorBrush CompletionSelectionForegroundBrush = SolidColorBrush.Parse("#5389F4");
    public static readonly SolidColorBrush CompletionForegroundBrush = SolidColorBrush.Parse("#B4B8BF");
