...
public static class MauiProgram
{
    ...
    private static MauiAppBuilder ConfigureServices(this MauiAppBuilder mauiAppBuilder)
    {
        ...
        mauiAppBuilder.Services.AddSingleton<IRoleService, RoleService>();
    ...
    private static MauiAppBuilder ConfigureViews(this MauiAppBuilder mauiAppBuilder)
    {
        ...
        mauiAppBuilder.Services.AddTransientWithShellRoute<CheckWebLinksPage, CheckWebLinksPageViewModel>("checkWebLinks");
    ...
    private static MauiAppBuilder ConfigurePopups(this MauiAppBuilder mauiAppBuilder)
    {
        ...
        mauiAppBuilder.Services.AddTransientPopup<SelectWebLinkPopup, SelectWebLinkPopupViewModel>();
