                ...
                new KeyFrame
                {
                    Setters =
                    {
                        new Setter(
                            ...
                            length),
                        new Setter(VisualBrush.OpacityProperty, 0d)
                    },
                    Cue = new Cue(0d)
                },
                new KeyFrame { Setters = { new Setter(VisualBrush.OpacityProperty, 1d) }, Cue = new Cue(0.05d) },
                new KeyFrame
                {
                    Setters =
                    {
                        new Setter(VisualBrush.OpacityProperty, 1d),
                        new Setter(
                            isVertical ? TranslateTransform.YProperty : TranslateTransform.XProperty,
                            0.0)
                    },
