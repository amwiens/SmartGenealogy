...
public class FontIconsViewModel : BaseViewModel
{
    ...
    private void CreateIconCollection()
    {
        _fontIconGroup = new ObservableCollection<FontIconGroupModel>
        {
            new FontIconGroupModel( "Smart Genealogy Icons", (List<FontIconModel>)smartGenealogy) ,
    ...
    public readonly IList<FontIconModel> smartGenealogy =
        typeof(SmartGenealogyIcons).GetFields()
            .Select(x => new FontIconModel
            {
                Type = "Smart Genealogy Icons",
                Name = x.Name,
