...
public partial class UpdateViewModel : ContentDialogViewModelBase
{
    ...
    [GeneratedRegex(@"(##\s*(v[0-9]+\.[0-9]+\.[0-9]+(?:-(?:[0-9A-Za-z-.]+))?)((?:\n|.)+?))(?=(##\s*v[0-9]+\.[0-9]+\.[0-9]+)|\z)")]
    ...
    private async Task InstallUpdate()
    {
        ...
        UpdateText = string.Format(Resources.TextTemplate_UpdatingPackage, Resources.Label_SmartGenealogy);
        ...
        UpdateText = "Update complete. Restarting Smart Genealogy in 3 seconds...";
        await Task.Delay(1000);
        UpdateText = "Update complete. Restarting Smart Genealogy in 2 seconds...";
        await Task.Delay(1000);
        UpdateText = "Update complete. Restarting Smart Genealogy in 1 second...";
        await Task.Delay(1000);
        UpdateText = "Update complete. Restarting Smart Genealogy...";
