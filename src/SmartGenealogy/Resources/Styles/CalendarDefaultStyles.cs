...
public static class CalendarDefaultStyles
{
    #region Properties
    ...
    public static Style CreateDefaultDayViewCurrentMonthStyle()
    {
        ...
        style.Setters.Add(new Setter() { Property = VisualElement.BackgroundColorProperty, Value = Microsoft.Maui.Graphics.Colors.Transparent });
        style.Setters.Add(new Setter() { Property = DayView.TextColorProperty, Value = Microsoft.Maui.Graphics.Colors.Black });
    ...
    public static Style CreateDefaultDayViewSelectedStyle()
    {
        ...
        style.Setters.Add(new Setter() { Property = DayView.TextColorProperty, Value = Microsoft.Maui.Graphics.Colors.White });
