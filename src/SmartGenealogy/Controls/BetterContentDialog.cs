...
public class BetterContentDialog : ContentDialog
{
    ...
    public static readonly StyledProperty<double> MinDialogWidthProperty =
        AvaloniaProperty.Register<BetterContentDialog, double>(
            "MinDialogWidth");
    ...
    public static readonly StyledProperty<Thickness> ContentMarginProperty =
        AvaloniaProperty.Register<BetterContentDialog, Thickness>(
            "ContentMargin");
    ...
    private void TrySetButtonCommands()
    {
        ...
        if (SecondaryButton is not null)
        {
            ...
            {
                SecondaryButton.IsVisible = IsPrimaryButtonEnabled && !string.IsNullOrEmpty(SecondaryButtonText);
            }
        }
    ...
    private void OnLoaded(object? sender, RoutedEventArgs? e)
    {
        ...
        {
            // Find the named grid
            // https://github.com/amwx/FluentAvalonia/blob/master/src/FluentAvalonia/Styling/ControlThemes/FAControls/ContentDialogStyles.axaml#L96
