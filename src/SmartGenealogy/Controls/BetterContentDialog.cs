...
public class BetterContentDialog : ContentDialog
{
    ...
    // Also get button properties to hid on command execution change
    [NotNull]
    ...
    public static readonly StyledProperty<bool> IsFooterVisibleProperty =
        AvaloniaProperty.Register<BetterContentDialog, bool>("IsFooterVisible", true);
    ...
    public static readonly StyledProperty<double> MinDialogHeightProperty =
        AvaloniaProperty.Register<BetterContentDialog, double>("MinDialogHeight");
